--SIMPLE DOOR LOCK SYSTEM BY TYKE--
ESX = nil
	...
	while true do
		...
		for i=1, #Config.DoorList do
			...
			if distance < maxDistance then
				...
				local displayText = 'Unlocked' --Ouvert
				if doorID.locked then
					displayText = 'Locked' --Fermer
				end
